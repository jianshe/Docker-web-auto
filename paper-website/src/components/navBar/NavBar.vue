<template>
  <div class="header">
    <div class="navBar" :class="{ open: isOpenMenu }">
      <div class="nav_logo"><router-link to="/">公司名称</router-link></div>
      <div class="nav_menu">
        <router-link
...
export default {
  data() {
    return {
      navMenuList: [
        //导航
        { id: "001", path: "/home", itemName: "首页" },
        { id: "002", path: "/about", itemName: "关于我们" },
        // { id: "003", path: "/course", itemName: "课程分类" },
        // { id: "004", path: "/teacher", itemName: "教师团队" },
        { id: "003", path: "/product", itemName: "产品中心" },
        { id: "004", path: "/engineerCase", itemName: "工程案例" },
        { id: "005", path: "/news", itemName: "新闻动态" },
        { id: "006", path: "/knowledges", itemName: "行业知识" },
        { id: "007", path: "/contact", itemName: "联系我们" },
      ],
